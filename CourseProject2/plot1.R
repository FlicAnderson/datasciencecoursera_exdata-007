## Coursera :: ExploratoryDataAnalysis :: CourseProject2 :: plot1.R
## ======================================================================== 
## (23rd October 2014)
...
# read in Source Classification Code Table (SCC):
  # provides a mapping from the SCC digit strings int he Emissions table to the 
...
# show total PM2.5 emissions from ALL sources for ea. of: 1999, 2002, 2005, 2008